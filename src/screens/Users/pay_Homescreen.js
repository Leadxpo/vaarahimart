...
export default function Homescreen  ({ navigation }) {
  const [p1Count, setP1Count] = useState(1);
  const [p2Count, setP2Count] = useState(1);
  const p1Price = 1;
  const p2Price = 5;

  const updateVariable = (property) => {
    if (property === 'p1Increase') {
      setP1Count((prevCount) => prevCount + 1);
    } else if (property === 'p1Decrease' && p1Count > 0) {
      setP1Count((prevCount) => prevCount - 1);
    } else if (property === 'p2Increase') {
      setP2Count((prevCount) => prevCount + 1);
    } else if (property === 'p2Decrease' && p2Count > 0) {
      setP2Count((prevCount) => prevCount - 1);
    }
  };
      ...
      <View style={styles.Group0104}>
        ...
        <View style={styles.Container}>
          ...
          <View style={styles.Product}>
            <View style={styles.Rectangle3}>
              <Image
                ...
                source={require('../../utilities/images/logo.png')}
              />
            </View>
            ...
            <View style={styles.Group383}>
              ...
              <View style={styles.Group738}>
                <TouchableOpacity onPress={() => updateVariable('p1Decrease')}>
                  <Image
                ...
                <Text style={styles._1}>{p1Count}</Text>
                
                <TouchableOpacity onPress={() => updateVariable('p1Increase')}>
                  <Image
          ...
          <View style={styles.Product}>
            ...
            <View style={styles.Group383}>
              <Text style={styles.PriceRs1ItemAwesomeP}>
                Price: Rs. 5/item Awesome product description for product two.{' '}
              </Text>
              <View style={styles.Group738}>
                <TouchableOpacity onPress={() => updateVariable('p2Decrease')}>
                  <Image
                    style={styles.MinusSvgrepoCom1}
                    source={{
                ...
                <Text style={styles._1}>{p2Count}</Text>
                
                <TouchableOpacity onPress={() => updateVariable('p2Increase')}>
                  <Image
                    style={styles.PlusSvgrepoCom1}
                    source={{
          ...
          <Button
            onPress={() =>
              navigation.navigate('Pay_Checkout', {
                p1Count,
                p2Count,
                p1Price,
                p2Price,
