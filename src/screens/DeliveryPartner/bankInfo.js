...
export default function BankInfo({ navigation }) {
    ...
    const { loading: loadingUserData, deliveryInfo, error: UserDataError } = useSelector(state => state.deliveryDetails);
    ...
    const handleChangeBankInfo = () => {
        NavigationContainer.navigate("bankDetails", { deliveryParnerData: deliveryInfo })
    }
        ...
        <Surface>
            <View style={styles.card}>
                <View style={styles.detailRow}>
                    ...
                    <Text style={[styles.detailText, { flex: 1 }]}>{deliveryInfo.bank_name}</Text>
                ...
                <View style={styles.detailRow}>
                    ...
                    <Text style={[styles.detailText, { flex: 1 }]}>{deliveryInfo.bank_account_holder_name}</Text>
                </View>
                <View style={styles.detailRow}>
                    <View style={{ flexDirection: "row", flex: 3 }}>
                    ...
                    <Text style={[styles.detailText, { flex: 1 }]}>{deliveryInfo.bank_acount_no}</Text>
                </View>
                <View style={styles.detailRow}>
                    <View style={{ flexDirection: "row", flex: 3 }}>
                    ...
                    <Text style={[styles.detailText, { flex: 1 }]}>{deliveryInfo.bank_ifsc}</Text>
                </View>
                <View style={styles.detailRow}>
                    <View style={{ flexDirection: "row", flex: 3 }}>
                        <MaterialCommunityIcons name="map-marker-outline" size={22} color="#333" />
                    ...
                    <Text style={[styles.detailText, { flex: 1 }]}>{deliveryInfo.bank_branch}</Text>
                </View>
            </View>
